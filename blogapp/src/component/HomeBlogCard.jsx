...
export default function HomeBlogCard({ eachPost }) {
    ...
    const readButton = async () => {
        ...
        navigate('/readblog/' + eachPost.slug)
    }
    useEffect(() => {
        getImage();
    }, [])
    ...
    return (
        <div className=' flex mx-8 mt-4 p-4 border-black border border-opacity-50  bg-black bg-opacity-30 shadow-2xl shadow-purple-900 rounded-2xl'>
            ...
            <div className='ml-8 w-3/4'>
                ...
                <p className="mt-2 text-xl text-gray-200 dark:text-gray-400">{parse(content)} </p>
                <div className=" flex justify-between mt-4   items-center">
                    <div className='flex items-center'>
                        <div className="flex items-center">
                            <img className="object-cover h-10 w-10 rounded-full" src="https://cdn.dribbble.com/users/2199928/screenshots/11532918/media/5a7273b592ea860e6d0ff2931ecab4f3.png?resize=400x300&vertical=center" alt="Avatar" />
