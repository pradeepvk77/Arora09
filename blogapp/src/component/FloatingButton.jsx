    ...
    return(
        <div className="sticky bottom-16 pr-20 space-y-2 w-full items-end flex flex-col justify-end">
                    <button onClick={addBlogButton}
                        ...
                        type="button"
                    >
                       <span className="p-1 pr-2 "> <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#000000" version="1.1" id="Capa_1" width="20px" height="20px" viewBox="0 0 45.402 45.402" xmlSpace="preserve">
                            <g>
